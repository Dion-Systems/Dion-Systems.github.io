...
function OpenImgModal(event, title, desc, img)
{
	let overlay = document.getElementById('modal');
	let title_html = document.getElementById('img_modal_title')
	let desc_html  = document.getElementById('img_modal_desc');
    let image_html = document.getElementById('img_modal_img');
    overlay.style.display = 'flex';
	title_html.innerText = title;
	desc_html.innerText = desc;
	image_html.src = img;
}
